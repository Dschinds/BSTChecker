...
public class Solution {
    ...
    public static boolean isBst(BinaryTreeNode root, int lowerBound,int upperBound){
        if(root == null){
            return true;
        }
        ...
        return isBst(root.left,lowerBound, root.value) && isBst(root.right,root.value,upperBound);
    }
